...
export default function UserToggleComfirmModal({ modalFlagConfirm, updateModalFlagConfirm, selectedStatus, setSelectedStatus }: any) {
  const theme = useTheme();
  return (
    <Dialog
      open={modalFlagConfirm?.userToggleComfirmModal}
      onClose={() => {
        // handleToggle();
        updateModalFlagConfirm('userToggleComfirmModal', false);
      }}
